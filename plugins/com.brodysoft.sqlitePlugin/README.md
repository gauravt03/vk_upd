...
- Discussion forum at [Ost.io / @liteglue / Cordova-sqlite-storage](http://ost.io/@liteglue/Cordova-sqlite-storage)
...
If you have any questions about the plugin please post them to the new discussion forum at [Ost.io / @liteglue / Cordova-sqlite-storage](http://ost.io/@liteglue/Cordova-sqlite-storage)
...
- If you see a need for restructuring, it is the most handy to first discuss it in the forum at [Ost.io / @liteglue / Cordova-sqlite-storage](http://ost.io/@liteglue/Cordova-sqlite-storage) where alternatives can be discussed before reaching a conclusion. If you want to propose a change to the project structure:
